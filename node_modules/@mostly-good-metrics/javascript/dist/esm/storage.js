...
class PersistenceManager {
    constructor() {
        ...
        this.inMemoryAnonymousId = null;
        this.inMemoryAppVersion = null;
        this.inMemorySuperProperties = {};
     ...
     */
    configureCookies(cookieDomain, disableCookies) {
     ...
     */
    initializeAnonymousId(overrideId, generateUUID) {
     ...
     */
    setIdentifyLastSentAt(timestamp) {
        if (isLocalStorageAvailable()) {
