...
import { delay, detectDeviceType, generateAnonymousId, generateUUID, getDeviceModel, getISOTimestamp, getLocale, getOSVersion, getTimezone, resolveConfiguration, sanitizeProperties, validateEventName, } from './utils';
...
export class MostlyGoodMetrics {
    ...
    constructor(config) {
        ...
        this.anonymousIdValue = persistence.initializeAnonymousId(config.anonymousId, generateAnonymousId);
        // Set up logging
